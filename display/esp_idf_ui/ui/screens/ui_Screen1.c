...
void ui_Screen1_screen_init(void)
{
    ...
    lv_obj_set_height(ui_Button1, 86);
    ...
    lv_obj_set_x(ui_Slider1, -184);
    lv_obj_set_y(ui_Slider1, 111);
    lv_obj_set_align(ui_Slider1, LV_ALIGN_CENTER);


    ui_Switch1 = lv_switch_create(ui_Screen1);
    lv_obj_set_width(ui_Switch1, 128);
    lv_obj_set_height(ui_Switch1, 64);
    lv_obj_set_x(ui_Switch1, 93);
