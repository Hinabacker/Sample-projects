...
void ui_Screen2_screen_init(void)
{
    ...
    ui_Container = lv_obj_create(ui_Screen2);
    lv_obj_remove_style_all(ui_Container);
    lv_obj_set_width(ui_Container, 784);
    lv_obj_set_height(ui_Container, 472);
    ...
    ui_TextArea = lv_textarea_create(ui_Container);
    ...
    ui_Keyboard = lv_keyboard_create(ui_Container);
